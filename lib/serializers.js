...
export const serializers = {
  types: {
    block: (props) => {
      ...
      if (style === 'enlargedParagraph') {
        return <p className="enlarge-paragraph">{props.children}</p>;
      }

      if (style === 'slightlyEnlargedParagraph') {
        return <p className="slightly-enlarge-paragraph">{props.children}</p>;
      }
