...
const WholesaleContactUsPage = ({ data }) => {
  ...
  return (
    <Layout site={site} page={page}>
      ...
      <PageContent>
        ...
        <ContactForm type="wholesaleContactEnquiry" />
      </PageContent>
    </Layout>
  );
};
...
export async function getStaticProps({ preview, previewData }) {
  const pageData = await getStaticPage(
    `
    *[_type == "wholesaleContactPage"] | order(_updatedAt desc)[0]{
      title,
      introText,
      additionalText,
      seo,
...
export default WholesaleContactUsPage;
